...
class GameWon(GameState):
    ...
    def __init__(self, data) -> None:
        ...
        self.ui_text = pyasge.Text(self.data.fonts['kenvector'], "WINNER!")
    ...
    def update(self, game_time: pyasge.GameTime) -> GameStateID:
        """ If return item is selected transition to appropriate state else return WINNER_WINNER """
